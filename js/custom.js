$(function() {
    ...
    const swiper = new Swiper('.mainBlock__slider', {
        loop: true,
        lidesPerView: 1,
    ...
    const countres__slider = new Swiper('.countres__slider', {
        loop: true,
        slidesPerView: 4,
        spaceBetween: 15,
    ...
    const services__slider = new Swiper('.services__slider', {
        loop: true,
        slidesPerView: 2,
        spaceBetween: 15,
    ...
    const news__wrapper = new Swiper('.news__wrapper', {
        loop: true,
        slidesPerView: 3,
        spaceBetween: 15,
